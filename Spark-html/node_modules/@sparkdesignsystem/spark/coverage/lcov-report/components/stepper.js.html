...
<head>
    <title>Code coverage report for components/stepper.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">components</a> stepper.js</h1>
        <div class='clearfix'>
...
&nbsp;
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (event.keyCode === keys.end) {
        event.preventDefault();
        resetTabs(steps, descriptions, activeClass);
        setActiveTab(
