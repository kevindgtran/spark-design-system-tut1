...
<head>
    <title>Code coverage report for components/modals.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">components</a> modals.js</h1>
        <div class='clearfix'>
...
const hideModal = (modal, mask, main) =&gt; {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (modalTrigger) {
    modalTrigger.focus();
  }
};
&nbsp;
