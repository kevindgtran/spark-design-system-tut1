...
<head>
    <title>Code coverage report for components/masthead.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">components</a> masthead.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">97.62% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>123/126</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* global document window */
...
const checkScrollDirection = throttle(() =&gt; {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (direction !== newDirection) {
<span class="cstat-no" title="statement not covered" >    toggleMenu(newDirection);</span>
  }
...
const toggleScrollEvent = (isMenuVisible) =&gt; {
  ...
  if (!isMenuVisible) {
    const masthead = document.querySelector('[data-sprk-masthead]');
    <span class="missing-if-branch" title="else path not taken" >E</span>if (masthead) {
      masthead.classList.remove('sprk-c-Masthead--hidden');
    }
  }
  if (isMenuVisible) {
...
&nbsp;
    // init aria-expanded
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!element.hasAttribute('aria-expanded')) {
...
&nbsp;
     ...
     */
    let isMenuVisible;
    window.addEventListener('load', <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      isMenuVisible = isElementVisible('.sprk-c-Masthead__menu');</span>
<span class="cstat-no" title="statement not covered" >      toggleScrollEvent(isMenuVisible);</span>
    });
    /*
    ...
    window.addEventListener(
      ...
      throttle(() =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (isMenuVisible !== newMenuVisibility) {
