...
<head>
    <title>Code coverage report for components/tabs.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">components</a> tabs.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import getElements from '../utilities/getElements';
&nbsp;
...
&nbsp;
  resetTabs(tabs, tabpanels, activeClass);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (activeIndex - 1 === -1) {
<span class="cstat-no" title="statement not covered" >    setActiveTab(</span>
      tabs[tabs.length - 1],
